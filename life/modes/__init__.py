...
def register_all_modes(App):
    ...
    reg_evo(App)
    from life.modes.evolution_lab import register as reg_elab
    reg_elab(App)
    ...
    reg_tmound(App)
    from life.modes.bee_colony import register as reg_bee
    reg_bee(App)
    ...
    reg_ww(App)
    from life.modes.rule_editor import register as reg_re
    reg_re(App)
    ...
    reg_granular(App)
    from life.modes.earthquake import register as reg_quake
    reg_quake(App)
    ...
    reg_cardiac(App)
    from life.modes.cortical import register as reg_cortical
    reg_cortical(App)
